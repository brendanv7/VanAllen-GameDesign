...
while not done:
    ...
    # Change the previous head segment to white
    prev_head = snake_segments[0]
    prev_head.image.fill(WHITE)
    segment_group.add(prev_head)
    ...
    segment_hit_list = pygame.sprite.spritecollide(head, segment_group, False)
    if len(segment_hit_list) > 0:
        print("GAME OVER")
