...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # Draw bullet onto the hit block
        bullet_width = 4
        bullet_height = 10
        bullet_x = Block.WIDTH // 2 - bullet_width // 2
        bullet_y = Block.HEIGHT // 2 - bullet_height // 2
        pygame.draw.rect(self.image, BLACK, [bullet_x, bullet_y, bullet_width, bullet_height])
...
while not done:
    ...
    for bullet in bullet_list:
        ...
        # Remove the bullet if it hits the backstop
